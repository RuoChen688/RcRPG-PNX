            ...
            case "weapon":
                switch(args.get(1)){
                    ...
                    case "add":
                        ...
                        Config config;
                        if((config = Weapon.addWeaponConfig(args.get(2),id)) != null){
            ...
            case "armour":
                switch(args.get(1)){
                    ...
                    case "add":
                        ...
                        Config config;
                        if((config = Armour.addArmourConfig(args.get(2),id)) != null){
            ...
            case "stone":
                switch(args.get(1)){
                    ...
                    case "add":
                        ...
                        Config config;
                        if((config = Stone.addStoneConfig(args.get(2),id)) != null){
            ...
            case "magic":
                switch(args.get(1)){
                    ...
                    case "add":
                        ...
                        Config config;
                        if((config = Magic.addMagicConfig(args.get(2),id)) != null){
